...
* `themes/edo-nezu-dark-color-theme.json` - the dark color theme definition file.
* `themes/edo-nezu-light-color-theme.json` - the light color theme definition file.
